package bytesnek.snakerlib.math;
...
public class Tensor extends PoseStack
{
    ...
    public Tensor(PoseStack parent)
    {
        this.parent = parent;
        this.funny = true;
    }
     ...
     **/
    public static Tensor of(PoseStack other)
    {
     ...
     **/
    public <T extends Entity> Tensor funny(T entity)
    {
    ...
    /**
     * Specifies whether the Entity passed into {@link Tensor#funny} should rotate or not
     *
     * @param funny Should {@link Tensor#funny} be active
     **/
     ...
     **/
    public Tensor scale(double x, double y, double z)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor scale(Vector3f scale)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor translate(double translation)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor translate(Vector3f translation)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor translate(Vector3d translation)
    {
        parent.translate(translation.x, translation.y, translation.z);
        return this;
    }
     ...
     * @return The current pose stack builder
     **/
    public Tensor rotate(Quaternionf rotation)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor rotate(double x, double y, double z)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor rotate(double x, double y, double z, double w)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor rotate(Double[] rotation)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor rotateAround(Quaternionf rotation, Vector3f pos)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor rotateAround(Vector4f rotation, Vector3f pos)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor rotateAround(Quaternionf rotation, double x, double y, double z)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor rotateAround(double x1, double y1, double z1, double w, double x2, double y2, double z2)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor rotateAround(double x1, double y1, double z1, double x2, double y2, double z2)
    {
     ...
     * @return The current pose stack builder
     **/
    public Tensor rotateAround(Double[] rotation, Double[] pos)
    {
        assertCorrectLength(rotation, 4);
