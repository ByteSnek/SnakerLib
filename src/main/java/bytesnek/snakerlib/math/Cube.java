...
public class Cube
{
    ...
    public Cube(VertexConsumer consumer, PoseStack stack)
    {
        this.consumer = consumer;
        this.stack = stack;
    }

    public Cube(MultiBufferSource source, RenderType type, PoseStack stack)
    {
     ...
     **/
    public static Cube create(VertexConsumer consumer, PoseStack stack)
    {
        return new Cube(consumer, stack).draw();
    }
     ...
     * @return The drawn basic cube
     **/
    private Cube draw(VertexConsumer consumer, PoseStack stack)
    {
     ...
     * @return The drawn basic cube
     **/
    private Cube draw(VertexConsumer consumer, Matrix4f matrix)
    {
