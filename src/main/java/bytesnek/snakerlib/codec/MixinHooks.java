package bytesnek.snakerlib.codec;
...
import bytesnek.snakerlib.internal.mixin.accessor.BiomeGenerationSettingsAccessor;
import bytesnek.snakerlib.internal.mixin.accessor.BiomeSpecialEffectsAccessor;
import bytesnek.snakerlib.internal.mixin.accessor.SinglePoolElementAccessor;
...
public final class MixinHooks
{
    ...
    private static <R> void loadRegistryData(ResourceManager resourceManager, RegistryOps.RegistryInfoLookup registryInfoLookup, RegistryDataPair<R> pair, List<String> errors)
    {
        ...
        final String registryName = CommonHooks.prefixNamespace(registryKey.location());
    ...
    public static Codec<Biome> makeBiomeCodec(Codec<BiomeSpecialEffects> specialEffectsCodec, Codec<PlacedFeature> placedFeatureCodec, MapCodec<BiomeGenerationSettings> biomeGenerationSettingsCodec)
    {
        ...
        ).apply(instance, MixinHooks::makeBiome));
    }
    ...
    public static Codec<Biome> makeBiomeCodec()
    {
        ...
        return makeBiomeCodec(specialEffectsCodec, placedFeatureCodec, biomeGenerationSettingsCodec);
    }
