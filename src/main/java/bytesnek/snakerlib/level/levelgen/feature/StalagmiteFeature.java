package bytesnek.snakerlib.level.levelgen.feature;
...
public class StalagmiteFeature extends BlockBlobFeature
{
    ...
    public StalagmiteFeature(Codec<BlockStateConfiguration> codec, int frequency, List<Block> blocksToPlaceOn, int minHeightRange, int maxHeightRange)
    {
        super(codec);
