...
public class BulkRegistrySet extends RegistrySetBuilder
{
    ...
    private final MultiMap<ResourceKey<? extends Registry<?>>, RegistryBootstrap<?>> map;
    ...
    @SafeVarargs
    public final <T> BulkRegistrySet addAll(ResourceKey<? extends Registry<T>> key, RegistryBootstrap<T>... bootstraps)
    {
    ...
    @SafeVarargs
    public final BulkRegistrySet addAllPlacements(RegistryBootstrap<PlacedFeature>... bootstraps)
    {
    ...
    @SafeVarargs
    public final BulkRegistrySet addAllConfigs(RegistryBootstrap<ConfiguredFeature<?, ?>>... bootstraps)
    {
    ...
    @SafeVarargs
    public final BulkRegistrySet addAllModifiers(RegistryBootstrap<BiomeModifier>... bootstraps)
    {
