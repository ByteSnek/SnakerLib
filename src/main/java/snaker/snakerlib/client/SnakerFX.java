 ...
 **/
public class SnakerFX
{
    public static void createRay(PoseStack stack, MultiBufferSource source, Color color, int min, float max, int amount, double offsetX, double offsetY, double offsetZ)
    {
