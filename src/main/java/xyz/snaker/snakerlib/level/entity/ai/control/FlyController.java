package xyz.snaker.snakerlib.level.entity.ai.control;
...
public class FlyController extends MoveControl
{
    ...
    /**
     * The duration left until the {@link MoveControl#operation} gets set to {@link Operation#WAIT}
     **/
    private int duration;

    /**
     * Constructs a new FlyController instance
     *
    ...
    /**
     * Tasks to do every tick while this controller is being used
     **/
    @Override
    public void tick()
    {
