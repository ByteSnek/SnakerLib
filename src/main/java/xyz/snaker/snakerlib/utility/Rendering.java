...
public class Rendering
{
     ...
     **/
    public static final BiFunction<Integer, LivingEntity, Vector2i> ENTITY_PACKED_COMPONENTS = (packedLight, entity) -> new Vector2i(packedLight, Rendering.packOverlay(entity));
    ...
    public static SRTP createFreshProcessor()
    {
        return new SRTP()
        {
            @Override
            ...
            {
                return SRTP.super.sampler(shader, blur, mipmap, samplers);
            }
